...
def page_project_hypothesis_body():
    ...
    st.warning(
        ...
        f"- PCA visualization suggests moderate class separability, "
        f"though additional feature engineering may improve it.\n"
    ...
    st.warning(
        ...
        f"- Confusion matrix confirms low false negatives, meaning "
        f"reliable detection.\n"
        f"- ROC Curve shows AUC score (**≥0.90**, replace with value).\n"
        f"Conclusion: The ML model meets performance expectations but can "
        f"be improved with further tuning."
    )
    ...
    st.info(
        ...
        f"- **Interactive Image Confidence Check:** Allow users to "
        f"analyze confidence scores in Streamlit.\n"
    ...
    st.warning(
        ...
        f"predicting 'Healthy' with high confidence), it may indicate "
        f"class imbalance.\n"
